...
public class chat_test extends Thread{

    public static void main(String[] args) throws ClientProtocolException, IOException
    {
        int n = 1;
        String user_1 = "478086183";//两个连麦用户
        String user_2 = "238570026";
        long time_1 = 1200000;//一次调取30分钟
        long time_2 = 300000;//休眠时间5分钟
        String url="http://qa.igame.163.com/api/backend/livestream/rtc/add";
        String cookie="PMS_U=3e463f0266bcf3b97424a9e0461830fced777d8e1e8f28331a981646d554c4302c2cb0f9895bf06ac147c32c74e894a7addd0724a0802dc5cafca02206cba5c99dad6f87cac5208c";

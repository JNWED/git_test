...
class TestLogin(BaseTestCase):
    ...
    def commom_ops(self):
        if self.tester.is_element_exist_ios('xpath', '//XCUIElementTypeStaticText[@name="我的消息"]'):
    ...
    def test_login_01_Anonymously(self):
        ...
        self.commom_ops()
        time.sleep(2)
        self.assertTrue(self.tester.is_element_exist_ios('xpath', '//XCUIElementTypeStaticText[@name="账号"]')or
                        self.tester.is_element_exist_ios('xpath', '//XCUIElementTypeStaticText[@name="我的消息"]'), "匿名登陆失败")
